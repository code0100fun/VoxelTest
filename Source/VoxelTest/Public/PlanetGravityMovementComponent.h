...
#include "PlanetGravityMovementComponent.generated.h"

/**
 * 
 */
UCLASS()
class VOXELTEST_API UPlanetGravityMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()

public:
	UPlanetGravityMovementComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	*/
	UPROPERTY(Category = "Planet Gravity Movement", BlueprintReadWrite, EditAnywhere)
...
public:
	...
	*/
	UFUNCTION(Category = "Pawn|Components|PlanetGravityMovement", BlueprintCallable)
